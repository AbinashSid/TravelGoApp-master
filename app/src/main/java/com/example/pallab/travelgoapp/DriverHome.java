...
public class DriverHome extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CircleImageView imageAvater = (CircleImageView) navigationHeaderView.findViewById(R.id.image_avatar);
        //WE can access from common.current user because in MainActivity , after log in ,We have set this data
        txtName.setText(Common.currentUser.getName());
        txtStars.setText(Common.currentUser.getRates());

        //but with Avater ,we just check it will null or empty
        ...
        location_switch.setOnCheckedChangeListener(new MaterialAnimatedSwitch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(boolean isOnline) {
                if (isOnline) {
                    ...
                    FirebaseDatabase.getInstance().goOffline(); //set Disconnect  when switch sis off
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        //First ,you need add avater property on user model
        ...
        alertDialog.setPositiveButton("CHANGE PASSWORD", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (edtNewPassword.getText().toString().equals(edtRepeatPassword.getText().toString())) {
                    ...
                    //get auth credential from the useer for re authentication
                    //ex with oonly email
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            //update driver information password coulmn
                                                            ...
                                                            Toast.makeText(DriverHome.this, "Password doesn't Changes", Toast.LENGTH_SHORT).show();
                    ...
                    waitingDialog.dismiss();
                    Toast.makeText(DriverHome.this, "Password doesnt matched ", Toast.LENGTH_SHORT).show();
                }
            }
        });
        alertDialog.setNegativeButton("CANCEL", new DialogInterface.OnClickListener() {
...
//show dialog
    ...
    private void signout() {
        ...
        Intent intent = new Intent(DriverHome.this, UserActivity.class);
