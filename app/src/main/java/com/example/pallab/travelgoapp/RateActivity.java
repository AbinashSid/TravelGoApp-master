...
import com.example.pallab.travelgoapp.Model.Rate;
        ...
        rateDetailRef.child(driverId)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        //if upload succed on firebase just calcluate the average rating and update
                        rateDetailRef.child(driverId)
                                        ...
                                        driverInformationRef.child(Common.driverId)
                                                ...
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        alertDialog.dismiss();
                                                        Toast.makeText(RateActivity.this, "Rate updated but cnt write to driver information", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                    }
